...
class Manager(models.Model):
	...
	title = models.CharField(unique=True, blank=False, null=False,
        max_length=255, help_text="The title of this coordination position.")
	url_title = models.CharField(blank=False, null=False, max_length=255,
        help_text="The unique URL key for this coordinator. Autogenerated from custom interface.")
	...
	compensation = models.TextField(blank=True, null=True, help_text="The compensation for this coordinator.")
	duties = models.TextField(blank=True, null=True, help_text="The duties of this manager.")
	email = models.EmailField(blank=True, null=True, max_length=255, help_text="The e-mail address of this coordinator.")
	president = models.BooleanField(default=False, help_text="Whether this coordinator has president privileges (edit coordinators, bylaws, etc.).")
	workshift_manager = models.BooleanField(default=False, help_text="Whether this coordinator has workshift coordinator privileges (assign workshifts, etc.).")
	active = models.BooleanField(default=True, help_text="Whether this is an active coordinator position (visible in directory, etc.).")
...
class RequestType(models.Model):
	...
	url_name = models.CharField(max_length=255, unique=True, blank=False, null=False, help_text="Unique URL key for this coordinator.  Autogenerated from custom interface.")
	managers = models.ManyToManyField(Manager, help_text="Coordinators to whom this type of request is made.")
...
class Request(models.Model):
	...
	filled = models.BooleanField(default=False, help_text="Whether the coordinatorr deems this request filled.")
	closed = models.BooleanField(default=False, help_text="Whether the coordinator has closed this request.")
...
class Response(models.Model):
	...
	manager = models.BooleanField(default=False, help_text="Whether this is a relevant coordinator response.")
...
class Announcement(models.Model):
	...
	'''
	manager = models.ForeignKey(Manager, blank=False, null=False, help_text="The coordinator who made this announcement.")
