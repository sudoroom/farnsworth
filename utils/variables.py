...
MESSAGES = {
	...
	'NO_MANAGER': u"The coordinator page {managerTitle} could not be found.",
	'NO_REQUEST_TYPE': u"The request type {requestType} could not be found.",
	'MANAGER_ADDED': u"Coordinator {managerTitle} has been successfully added.",
	'MANAGER_SAVED': u"Coordinator {managerTitle} has been successfully saved.",
